...
export default function Hero() {
    return (
        <section className={`${styles.container} max-sm:text-center gap-8 px-4 py-16 md:flex md:px-16 max-w-screen-xl m-auto`}>
            <div className={`${styles.hero__left} mb-16 flex-1`}>
                ...
                <p className={`${styles.hero__description} mt-4 text-black/70`}>
                    Pantau perkembangan tentang <span className='font-bold underline decoration-2 decoration-teal-400'>
                        COVID-19
                    </span> secara tepat dan akurat. Tetap aman di rumah dan selalu pakai masker ketika ke tempat ramai. 
                </p>
                    <p className='mb-8 font-bold text-teal-400 underline decoration-2 decoration-teal-400'>#jangankendorpakaimasker</p>
            ...
            <div className={`${styles.hero__right} flex-[2] flex justify-end items-center`}>
                <img
                    className={`${styles.hero__image} max-w-full`}
                    src="/assets/hero.png"
                    alt="hero image"
                    width='600'
                />
